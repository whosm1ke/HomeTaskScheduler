...
public class UpdateQuestionSubmissionDtoValidator : AbstractValidator<UpdateQuestionSubmissionDto>
{
    public UpdateQuestionSubmissionDtoValidator(IUnitOfWork unitOfWork)
    {
